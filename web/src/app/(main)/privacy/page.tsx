...
export default function PrivacyPage() {
  return (
    <LegalPageLayout
      ...
      description="みらい議会＠葉山町の運営者（以下「当組織」といいます）における個人情報の取り扱いについてご説明します。"
    >
      <Container className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              ...
              "当組織の提供するサービスであるみらい議会＠葉山町におけるAIインタビュー機能（以下「みらい議会＠葉山町AIインタビュー機能」といいます。）を通じて取得される対話ログ、音声データ、および行動履歴",
        ...
        <section className="space-y-4">
          ...
          />
          <LegalParagraph>
            なお、みらい議会＠葉山町AIインタビュー機能を通じて当組織が取得した回答内容については、当組織は、以下の通り取り扱います。
          </LegalParagraph>
          <LegalList
            items={[
              {
        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              "「2. 個人情報の収集方法と使用範囲」に定めるみらい議会＠葉山町AIインタビュー機能を通じて当組織が取得した回答内容を、本人が公開に同意した範囲で公開する場合、および別途定める「みらい議会＠葉山町AIインタビューデータ利用規約」に同意する者であれば誰でもダウンロード可能なオープンデータとして第三者に提供する場合",
              "ユーザー本人の同意がある場合",

...
export const metadata: Metadata = {
  title: "利用規約 | みらい議会＠葉山町",
  description: "みらい議会＠葉山町の利用規約",
};
...
export default function TermsPage() {
  return (
    <LegalPageLayout
      ...
      description="みらい議会＠葉山町をご利用いただくにあたっての基本的なルールを定めています。"
    ...
    >
      <Container className="space-y-10">
        ...
        <LegalParagraph>
          みらい議会＠葉山町（以下「本サービス」といいます。）をご利用いただく場合、以下の規約に同意いただいたものとみなします。
        </LegalParagraph>
          ...
          <div className="space-y-3">
            ...
            <LegalList
              items={[
                ...
                "目的外利用：「みらい議会＠葉山町」の趣旨（葉山町議会提出議案等の関連テーマ）を著しく逸脱した応答を生成させる行為。",
